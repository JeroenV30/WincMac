...
leek_order = 'leek 4'
leek_order_amount = int(leek_order[:leek_order.find('leek')])
leek_sum_total = leek_price * leek_order_amount
print(leek_sum_total)

broccoli_price = float(2.34)
...
broccoli_string = str(broccoli_order_amount) + 'kg broccoli costs ' + str(round(broccoli_sum_total, 2) + 'e')
